...
public final class MemberAction_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("<title>Club Member Action</title>\n");
      out.write("<style>\n");
      out.write("textarea{\n");
      ...
      out.write("        <b><a href=\"Home.jsp\">Logout</a></b>\n");
      out.write("    </div>\n");
      ...
      out.write("</script> \n");
      out.write("<center>\n");
      out.write("    <font face=\"arial\" size=\"7\" color=\"white\"><b>Club Details</b></font>\n");
      out.write("    <table>\n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Event Name:</font></td>\n");
      out.write("        <td><input type=\"text\" size=30px name=\"ename\" required=\"required\"/><br></td>\n");
      out.write("        </tr>\n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Date:</font></td>\n");
      out.write("        <td><input type=\"date\" size=30px name=\"date\" required=\"required\"/><br></td>\n");
      out.write("        </tr>\n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Time:</font></td>\n");
      out.write("        <td><input type=\"time\"size=30px name=\"time\" required=\"required\"/><br></td>\n");
      out.write("        </tr>    \n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Venue:</font></td>\n");
      out.write("        <td><input type=\"text\"size=30px name=\"venue\" required=\"required\"/><br></td>\n");
      out.write("        </tr>    \n");
      out.write("        <tr>\n");
      out.write("        <td><label for=\"category\"><font size=\"5\">Choose a category:</font></label></td>\n");
      out.write("        <td>\n");
      out.write("            <select id=\"category\" name=\"category\">\n");
      out.write("            <option value=\"Pen-Paper\">Pen-Paper</option>\n");
      out.write("            <option value=\"Submission\">Submission</option>\n");
      ...
      out.write("        <br>\n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Amount:</font></td>\n");
      out.write("        <td><input type=\"number\" size=15px name=\"amount\" required=\"required\"/><br></td>\n");
      out.write("        </tr>\n");
      out.write("        <tr>\n");
      out.write("        <td><font size=\"5\">Description:</font></td>\n");
      out.write("        <td><textarea name=\"desc\" placeholder=\"description\" required=\"required\"></textarea><br></td>\n");
      out.write("        </tr>     \n");
      out.write("        <br><br>\n");
      out.write("        </table>\n");
      out.write("        <input type=\"submit\" name=\"done\" value=\"Add\" style=\"font-size:20px;color:white;background-color:midnightblue;padding:3px;width:100px\">\n");
      out.write("</center>\n");
    ...
    try{
        ...
        if(request.getParameter("done")!=null)
        {
            ...
            int i=st.executeUpdate("insert into Event(ENAME,DESCRIPTION, DATE, TIME, VENUE, CATEGORY, AMOUNT, CID) values('"+name+"','"+desc+"','"+date+"','"+time+"','"+venue+"','"+category+"',"+amount+","+cid+")");
            if(i>0)
                //response.sendRedirect("Event.jsp?target="+cname+"&user="+user);
                response.sendRedirect("ImgUpload.jsp?target=event&name="+name+"&user="+user+"&cname="+cname);
            else
